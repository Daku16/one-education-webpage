...
export default function NotFound() {
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-32 sm:px-6 md:px-8 lg:px-12">
      <section className="mx-auto flex w-full max-w-2xl flex-col items-center rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-sm sm:p-10">
        ...
        <p className="mt-4 text-sm leading-7 text-slate-600 sm:text-base">
          Es posible que el enlace haya cambiado o que el proyecto ya no exista.
        </p>
